        ...
        <div class="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
            <div class="text-white">
                <div class="flex items-center gap-2 mb-4">
                    ...
                    <span class="text-xl font-bold">U-Need-It</span>
                </div>
                <p class="text-gray-400 mb-4">Professionele reparatieservice voor al uw elektronische apparaten.</p>
            ...
            <div>
                <h4 class="text-white text-sm font-semibold uppercase tracking-wider mb-4">Diensten</h4>
                <ul class="space-y-3">
                    <li><a href="#" class="text-gray-400 hover:text-white transition-colors">Telefoon Reparatie</a></li>
                    <li><a href="#" class="text-gray-400 hover:text-white transition-colors">Laptop Reparatie</a></li>
                    <li><a href="#" class="text-gray-400 hover:text-white transition-colors">Tablet Reparatie</a></li>
                </ul>
            </div>

            <div>
                <h4 class="text-white text-sm font-semibold uppercase tracking-wider mb-4">Openingstijden</h4>
            ...
            <div>
                ...
                <ul class="space-y-3">
                    <li><a href="#" class="text-gray-400 hover:text-white transition-colors">Privacybeleid</a></li>
                    <li><a href="#" class="text-gray-400 hover:text-white transition-colors">Algemene Voorwaarden</a></li>
                    <li><a href="#" class="text-gray-400 hover:text-white transition-colors">Cookie Beleid</a></li>
                </ul>
            </div>
        </div>

        <div class="border-t border-gray-800 pt-8">
            <p class="text-gray-400 text-sm text-center">&copy; 2024 U-Need-It. Alle rechten voorbehouden.</p>
        </div>
    </div>
</footer>
</body>
